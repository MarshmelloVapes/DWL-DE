...
// Gruv Box
static const uint32_t col_fg    = 0xf2e5bcff; /* background (bg0 soft) */
static const uint32_t col_bg    = 0x3c3836ff; /* foreground (fg0) */
static const uint32_t col_blk   = 0x7c6f64ff; /* neutral gray */
static const uint32_t col_red   = 0xcc241dff; /* red */
static const uint32_t col_grn   = 0x98971aff; /* green */
static const uint32_t col_ylw   = 0xd79921ff; /* yellow */
static const uint32_t col_blu   = 0x458588ff; /* blue */
static const uint32_t col_mag   = 0xb16286ff; /* purple */
static const uint32_t col_cyn   = 0x689d6aff; /* aqua */
static const uint32_t col_brblk = 0x928374ff; /* light gray */
...
static const char *wmenucmd[] = { "fuzzel", NULL };

// Volume Controlls
static const char *volIncrease[] = { "pamixer", "--increase", "5", NULL };
static const char *volDecrease[] = { "pamixer", "--decrease", "5", NULL };
static const char *volTog[] = { "pamixer", "--toggle-mute", NULL };

// Brightness Controlls
static const char *brightIncrease[] = { "brightnessctl", "set", "5%+", NULL };
static const char *brightDecrease[] = { "brightnessctl", "set", "5%-", NULL };
...
static const Key keys[] = {
	...
	{ 0,                         XKB_KEY_F3,         spawn,          {.v = volIncrease} },
	{ 0,                         XKB_KEY_F2,         spawn,          {.v = volDecrease} },
	{ 0,                         XKB_KEY_F1,         spawn,          {.v = volTog} },
	{ 0,                         XKB_KEY_F6,         spawn,          {.v = brightIncrease} },
	{ 0,                         XKB_KEY_F5,         spawn,          {.v = brightDecrease} },
